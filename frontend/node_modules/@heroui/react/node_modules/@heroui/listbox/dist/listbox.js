...
function useListboxItem(originalProps) {
  ...
  const getItemProps = (props2 = {}) => ({
    ...
    ...(0, import_shared_utils2.mergeProps)(
      itemProps,
      isReadOnly ? {} : (0, import_shared_utils2.mergeProps)(focusProps, pressProps),
      hoverProps,
  ...
  const getDescriptionProps = (props2 = {}) => ({
    ...(0, import_shared_utils2.mergeProps)(descriptionProps, props2),
    className: slots.description({ class: classNames == null ? void 0 : classNames.description })
  });
  const getWrapperProps = (props2 = {}) => ({
    ...(0, import_shared_utils2.mergeProps)(props2),
...
var ListboxSection = (0, import_system3.forwardRef)(
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      ...
      {
        "data-slot": "base",
        ...(0, import_shared_utils3.mergeProps)(itemProps, otherProps),
        className: slots.base({ class: baseStyles }),
        children: [
...
var VirtualizedListbox = (props) => {
  ...
  const renderRow = (virtualItem) => {
    ...
    let listboxItem2 = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      {
        ...itemProps,
        classNames: (0, import_shared_utils6.mergeProps)(itemClasses, (_a2 = item.props) == null ? void 0 : _a2.classNames),
        shouldHighlightOnFocus,
        style: { ...virtualizerStyle, ...itemProps.style }
      },
      item.key
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Component, { ...getListProps(), children: [
    ...
    [...state.collection].map((item) => {
      ...
      let listboxItem2 = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        ...
        {
          ...itemProps,
          classNames: (0, import_shared_utils7.mergeProps)(itemClasses, (_a = item.props) == null ? void 0 : _a.classNames),
          shouldHighlightOnFocus
        },
        item.key
      );
