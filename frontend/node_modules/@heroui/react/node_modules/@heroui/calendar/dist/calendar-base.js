...
function useCalendarPicker(props) {
  ...
  const focusedDateRef = (0, import_react4.useRef)(state.focusedDate);
...
function CalendarBase(props) {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_react6.Fragment, { children: [
        i === 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          import_button2.Button,
          {
            ...
            onPress: (0, import_shared_utils6.chain)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Component, { ...(0, import_shared_utils6.mergeProps)(calendarProps, otherProps), ref, children: [
    topContent,
